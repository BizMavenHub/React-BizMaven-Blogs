    ...
    <div className="Contact_Container_ desktop:w-[1300px] w-[90%] m-auto">
      ...
      <div className="paragraph_container text-white">
        <section className="text-xl mb-4 tracking-wide">
          ...
          the gap between the digital realm and the tangible world, inviting our
        ...
        <section className="text-xl mb-4 tracking-wide">
          ...
          interaction as an opportunity to forge meaningful relationships,
        ...
        <section className="text-xl mb-4 tracking-wide">
          ...
          we're here to listen, engage, and connect with you on a deeper level.
          Together, let's embark on a journey of discovery, dialogue, and mutual
          respect. Thank you for being a part of our community—we look forward
