        ...
        {!mobile ? (
          ...
          <section className="pt-28 mobile:pt-6">
            <div className="flex w-[90%] m-auto mobile:flex-col">
              <div>
                {/* Block 1 - Intro */}
                <div className="w-[95%] m-left-auto mobile:w-full">
                  <h1 className=" text-white tablet mobile:text-[26pt] desktop:text-[55pt] largeDesktop:text-[70pt] font-medium font-roboto leading-none tracking-tight">
                    Welcome to{" "}
                    <span className=" text-yellow-400 dark:text-yellow-400">
                      Insight Loop
                    </span>
