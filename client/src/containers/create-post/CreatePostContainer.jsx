...
const CreatePostContainer = () => {
  return (
    <div className="w-[1000px] p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 m-auto">
      <h1 className="text-6xl font-bold text-center my-16">Create Post</h1>
        ...
        <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
          ...
          <div className="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
            ...
            <textarea
              id="editor"
              rows="8"
              className="block h-[500px] resize-none w-full px-0 text-sm focus:outline-none text-gray-800 bg-white border-0 dark:bg-gray-800 dark:text-white dark:placeholder-gray-400"
