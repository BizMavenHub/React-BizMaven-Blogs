...
const TermCondition = () => {
  return (
    <div className="w-[60%] m-auto text-lg">
      ...
      <p className="my-4">Welcome to Insight Loop!</p>
      <p className="my-4">
        These terms and conditions outline the rules and regulations for the use
        of Insight Loop's Website, located at https://www.insightloop.blog/.
      </p>
      <p className="my-4">
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Insight Loop if you do not agree to
      ...
      <p className="my-4">
        We employ the use of cookies. By accessing Insight Loop, you agreed to
        use cookies in agreement with the Insight Loop's Privacy Policy.
      </p>
      <p className="my-4">
      ...
      <p className="my-4">
        Unless otherwise stated, Insight Loop and/or its licensors own the
        intellectual property rights for all material on Insight Loop. All
        intellectual property rights are reserved. You may access this from
        Insight Loop for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>
      <p className="my-4">You must not:</p>
      <ul className="my-4">
        <li>Republish material from Insight Loop</li>
        <li>Sell, rent or sub-license material from Insight Loop</li>
        <li>Reproduce, duplicate or copy material from Insight Loop</li>
        <li>Redistribute content from Insight Loop</li>
      </ul>
      <p className="my-4">This Agreement shall begin on the date hereof.</p>
      <p className="my-4">
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        Insight Loop does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Insight Loop,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, Insight Loop shall not be
      ...
      <p className="my-4">
        Insight Loop reserves the right to monitor all Comments and to remove
      ...
      <p className="my-4">
        You hereby grant Insight Loop a non-exclusive license to use, reproduce,
      ...
      <p className="my-4">
        ...
        the hyperlink compensates the absence of Insight Loop; and (d) the link
      ...
      <p className="my-4">
        ...
        e-mail to Insight Loop. Please include your name, your organization
      ...
      <p className="my-4">
        No use of Insight Loop's logo or other artwork will be allowed for
