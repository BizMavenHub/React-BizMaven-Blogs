...
const PrivacyPolicy = () => {
  return (
    <div className="w-[70%] mx-auto">
      ...
      <h3 className="mb-3 font-medium text-xl">Interpretation</h3>
      <p className="mb-3 ">
      ...
      <h3 className="mb-3 font-medium text-xl">Definitions</h3>
      ...
      <ul className="list-disc ml-10">
        ...
        <li className="mb-3">
          <p>
            ...
            this Agreement) refers to Insight Loop.
          </p>
        </li>
        <li className="mb-3">
          <p>
        ...
        <li className="mb-3">
          <p>
            <strong>Website</strong> refers to Insight Loop, accessible from{" "}
            <a
              href="https://www.insightloop.blog/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.insightloop.blog/
            </a>
          </p>
        </li>
        <li className="mb-3">
      ...
      <h3 className="mb-3 font-medium text-xl">Types of Data Collected</h3>
      <h4 className="mb-3 font-medium ">Personal Data</h4>
      <p className="mb-3">
      ...
      <h4 className="mb-3 font-medium">Usage Data</h4>
      <p className="mb-3">
      ...
      <h4 className="mb-3 font-medium">Tracking Technologies and Cookies</h4>
      <p className="mb-3">
      ...
      <h3 className="mb-3 font-medium text-xl">Use of Your Personal Data</h3>
      <p className="mb-3">
      ...
      <h3 className="mb-3 font-medium text-xl">Delete Your Personal Data</h3>
      <p className="mb-3">
      ...
      <h4 className="mb-3 font-medium ">Business Transactions</h4>
      <p className="mb-3">
      ...
      <h4 className="mb-3 font-medium ">Law enforcement</h4>
      <p className="mb-3">
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h4 className="mb-3 font-medium ">Other legal requirements</h4>
      <p className="mb-3">
      ...
      <h2 className="mb-3 font-medium text-2xl">Children's Privacy</h2>
      <p className="mb-3">
      ...
      <h2 className="mb-3 font-medium text-2xl">Links to Other Websites</h2>
      <p className="mb-3">
      ...
      <h2 className="mb-3 font-medium text-2xl">Contact Us</h2>
      <p className="mb-3">
        If you have any questions about this Privacy Policy, You can contact us:
      </p>
      <ul className="list-disc ml-10">
        <li className="mb-3">
          <p>By email: bizmaven@protonmail.com</p>
        </li>
        <li className="mb-5">
          <p>
            By visiting this page on our website:{" "}
            <a
              href="https://www.insightloop.blog/contact-us"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.insightloop.blog/contact-us
            </a>
          </p>
        </li>
      </ul>
