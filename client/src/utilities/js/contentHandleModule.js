...
const blockQuoteModule =
  "prose-blockquote:text-gray-700 prose-blockquote:font-paragraph_font prose-blockquote:mb-4 prose-blockquote:ml-4 prose-blockquote:border-l-4 prose-blockquote:pl-4";

export { headingModules, listModules, blockQuoteModule };
